...
//    private Context mContext;
     ...
     */
    public boolean connect(Context context, String address, boolean reuseConnection) {
        Log.d(TAG, "BleManager connect entered");
        if (mAdapter == null || address == null) {
            Log.w(TAG, "BleManager: BluetoothAdapter not initialized or unspecified address.");
            return false;
        }
...
//        final boolean reuseExistingConnection = true;
        final boolean reuseExistingConnection = false;
//        final boolean
        Log.d(TAG, "reuse connection? " + reuseExistingConnection);
...
//        mGatt
    ...
    public void clearExecutor() {
        Log.d(TAG, "clearing mExecutor: " + mExecutor + "$$");
        if (mExecutor != null) {
            mExecutor.clear();
        }
    }
    ...
    */
    ...
    public void disconnect() {
        Log.d(TAG, "BleManager disconnect called -------------------");
        mDevice = null;
