            ...
            new BluetoothAdapter.LeScanCallback() {
                ...
                public void onLeScan(final BluetoothDevice device, final int rssi, final byte[] scanRecord) {
                    synchronized (mLeScansPoster) {
                        if (mServicesToDiscover == null || !Collections.disjoint(parseUuids(scanRecord), mServicesToDiscover)) {       // only process the menu_devices with uuids in mServicesToDiscover
