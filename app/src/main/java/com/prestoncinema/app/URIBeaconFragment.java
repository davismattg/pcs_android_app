...
import com.prestoncinema.app.shortener.BitlyShortenerAsyncTask;
import com.prestoncinema.app.shortener.ShortenerAsyncTask;
...
public class URIBeaconFragment extends Fragment implements ShortenerAsyncTask.ShortenerListener {
    ...
    private int verifyUriBeaconUri(String input) {
        ...
        String uri = flags + txpower + prefix + com.prestoncinema.ble.BleUtils.stringToHex(input);
