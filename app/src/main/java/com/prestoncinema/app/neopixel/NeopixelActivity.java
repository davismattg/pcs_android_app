package com.prestoncinema.app.neopixel;
...
import com.prestoncinema.app.FileUtils;
import com.prestoncinema.app.R;
import com.prestoncinema.app.UartInterfaceActivity;
import com.prestoncinema.ble.BleManager;
import com.prestoncinema.ui.utils.MetricsUtils;
import com.prestoncinema.ui.utils.TwoDimensionScrollView;
...
public class NeopixelActivity extends UartInterfaceActivity {
    ...
    private com.prestoncinema.ui.utils.TwoDimensionScrollView mCustomPanningView;
    ...
    private com.prestoncinema.app.neopixel.NeopixelBoard mBoard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e(TAG, "Error decoding default_lenses palette");
        }
        ...
        mCustomPanningView = (com.prestoncinema.ui.utils.TwoDimensionScrollView) findViewById(R.id.customPanningView);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_help) {
            ...
            Intent intent = new Intent(this, com.prestoncinema.app.neopixel.NeopixelBoardSelectorActivity.class);
            startActivityForResult(intent, kActivityRequestCode_NeopixelBoardSelectorActivity);
            return true;
        } else if (id == R.id.action_boardType) {
            if (mBoard != null) {
                Intent intent = new Intent(this, com.prestoncinema.app.neopixel.NeopixelBoardTypeActivity.class);
                intent.putExtra(com.prestoncinema.app.neopixel.NeopixelBoardTypeActivity.kActivityParameter_CurrentType, mBoard.type);
...
//        mBoardControlsViewGroup.setAlpha(mIsSketchDetected ? 1.0f : 0.2f);
    ...
    public void onClickColorPicker(View view) {
        Intent intent = new Intent(this, com.prestoncinema.app.neopixel.NeopixelColorPickerActivity.class);
        intent.putExtra(com.prestoncinema.app.neopixel.NeopixelColorPickerActivity.kActivityParameter_SelectedColorKey, mCurrentColor);
    ...
    protected void onActivityResult(final int requestCode, final int resultCode, final Intent intent) {
        if (resultCode == RESULT_OK) {
            if (requestCode == kActivityRequestCode_NeopixelColorPickerActivity && intent != null) {
                final int color = intent.getIntExtra(com.prestoncinema.app.neopixel.NeopixelColorPickerActivity.kActivityResult_SelectedColorResultKey, Color.WHITE);
                mCurrentColor = color;
                updatePickerColorButton(true);
            } else if (requestCode == kActivityRequestCode_NeopixelBoardSelectorActivity && intent != null) {
                final int boardIndex = intent.getIntExtra(com.prestoncinema.app.neopixel.NeopixelBoardSelectorActivity.kActivityResult_BoardIndexResultKey, -1);
                if (boardIndex >= 0) {
                    com.prestoncinema.app.neopixel.NeopixelBoard board = new com.prestoncinema.app.neopixel.NeopixelBoard(this, boardIndex, com.prestoncinema.app.neopixel.NeopixelBoard.kDefaultType);
                    changeBoard(board);
                } else {
                    final int lineStripLength = intent.getIntExtra(com.prestoncinema.app.neopixel.NeopixelBoardSelectorActivity.kActivityResult_LineStripResultKey, 0);
                    if (lineStripLength > 0) {
                        com.prestoncinema.app.neopixel.NeopixelBoard board = new com.prestoncinema.app.neopixel.NeopixelBoard("1x" + lineStripLength, (byte) lineStripLength, (byte) 1, (byte) 3, (byte) lineStripLength, com.prestoncinema.app.neopixel.NeopixelBoard.kDefaultType);
                        changeBoard(board);
                    }
                }
            } else if (requestCode == kActivityRequestCode_NeopixelBoardTypeActivity && intent != null) {
                final short boardType = (short) intent.getShortExtra(com.prestoncinema.app.neopixel.NeopixelBoardTypeActivity.kActivityResult_BoardTypeResultKey, com.prestoncinema.app.neopixel.NeopixelBoard.kDefaultType);
    ...
    private void changeBoard(com.prestoncinema.app.neopixel.NeopixelBoard board) {
        mBoard = board;
        if (mIsSketchDetected) {
    ...
    private void setupNeopixel(com.prestoncinema.app.neopixel.NeopixelBoard device) {
    ...
    private void startHelp() {
        ...
        Intent intent = new Intent(this, com.prestoncinema.app.neopixel.NeopixelHelpActivity.class);
...
//                    Log.d(TAG, "Palette color: " + index);
    ...
    private void restoreRetainedDataFragment() {
        ...
        if (mRetainedDataFragment == null) {
            ...
            mBoard = new com.prestoncinema.app.neopixel.NeopixelBoard(this, 0, com.prestoncinema.app.neopixel.NeopixelBoard.kDefaultType);
