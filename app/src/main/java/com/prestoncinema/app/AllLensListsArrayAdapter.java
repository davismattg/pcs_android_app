...
public class AllLensListsArrayAdapter extends ArrayAdapter<LensListEntity> {
    private ListSelectedListener listener;

    public AllLensListsArrayAdapter(Context context, ArrayList<LensListEntity> lists) {
