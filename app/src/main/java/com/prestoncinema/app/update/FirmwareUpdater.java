package com.prestoncinema.app.update;
...
public class FirmwareUpdater implements DownloadTask.DownloadTaskListener, BleManager.BleManagerListener {
    ...
    public static final String kDefaultPCSUpdateServerUrl = "http://prestoncinema.com/Upgrades/src/releases.xml";
    ...
    private com.prestoncinema.app.update.ProgressFragmentDialog mProgressDialog;
    private Activity mParentActivity;

    public interface FirmwareUpdaterListener {
        void onFirmwareUpdatesChecked(boolean isUpdateAvailable, com.prestoncinema.app.update.ReleasesParser.FirmwareInfo latestRelease, DeviceInfoData deviceInfoData, Map<String, com.prestoncinema.app.update.ReleasesParser.BoardInfo> allReleases);
    ...
    public boolean checkFirmwareUpdatesForTheCurrentConnectedDevice() {
        ...
        // Note: don't skip version check if internet is not available (because some characteristics can still be used to to display cached firmware updates)
...
*/
    ...
    public void downloadAndInstall(Activity activity, int type, String hexUri, String iniUri) {
        com.prestoncinema.app.update.ReleasesParser.BasicVersionInfo release = new com.prestoncinema.app.update.ReleasesParser.BasicVersionInfo();
    ...
    public void downloadAndInstall(Activity activity, com.prestoncinema.app.update.ReleasesParser.BasicVersionInfo originalRelease) {
        ...
        com.prestoncinema.app.update.ReleasesParser.BasicVersionInfo release;
        if (useHexOnly) {
            // Copy minimum fields required (and don't use the init file)
            release = new com.prestoncinema.app.update.ReleasesParser.BasicVersionInfo();
        ...
        if (isNetworkAvailable()) {
            ...
            mProgressDialog = new com.prestoncinema.app.update.ProgressFragmentDialog();
            Bundle arguments = new Bundle();
            arguments.putString("message", mContext.getString(release.fileType == com.prestoncinema.app.update.DfuService.TYPE_APPLICATION ? R.string.firmware_downloading : R.string.bootloader_downloading));          // message should be set before oncreate
        ...
        if (device != null) {                                                               // Check that we are still connected to the device
            ...
            mProgressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                ...
                public void onCancel(DialogInterface dialog) {
                    ...
                    final Intent pauseAction = new Intent(com.prestoncinema.app.update.DfuService.BROADCAST_ACTION);
                    pauseAction.putExtra(com.prestoncinema.app.update.DfuService.EXTRA_ACTION, com.prestoncinema.app.update.DfuService.ACTION_ABORT);
            ...
            Log.d(TAG, "update " + (fileType == com.prestoncinema.app.update.DfuService.TYPE_APPLICATION ? "firmware" : "bootloader") + " from hex: " + (localHexPath != null ? localHexPath + (localIniPath != null ? " ini:" + localIniPath : "") : hexUriPath.toString() + (iniUriPath != null ? " ini:" + iniUriPath.toString() : "")));
            ...
            final Intent service = new Intent(mContext, com.prestoncinema.app.update.DfuService.class);

            service.putExtra(com.prestoncinema.app.update.DfuService.EXTRA_DEVICE_ADDRESS, device.getAddress());
            service.putExtra(com.prestoncinema.app.update.DfuService.EXTRA_DEVICE_NAME, device.getName());
            service.putExtra(com.prestoncinema.app.update.DfuService.EXTRA_FILE_MIME_TYPE, fileType == com.prestoncinema.app.update.DfuService.TYPE_AUTO ? com.prestoncinema.app.update.DfuService.MIME_TYPE_ZIP : com.prestoncinema.app.update.DfuService.MIME_TYPE_OCTET_STREAM);
            service.putExtra(com.prestoncinema.app.update.DfuService.EXTRA_FILE_TYPE, fileType);
            service.putExtra(com.prestoncinema.app.update.DfuService.EXTRA_FILE_PATH, localHexPath);
            service.putExtra(com.prestoncinema.app.update.DfuService.EXTRA_FILE_URI, hexUriPath);
            service.putExtra(com.prestoncinema.app.update.DfuService.EXTRA_RESTORE_BOND, true);          // Always try to restore bond if the device was bonded when the update starts

            if (localIniPath != null) {
                service.putExtra(com.prestoncinema.app.update.DfuService.EXTRA_INIT_FILE_PATH, localIniPath);
            }
            if (iniStreamUri != null) {
                service.putExtra(com.prestoncinema.app.update.DfuService.EXTRA_INIT_FILE_URI, iniUriPath);
            }
    ...
    public void onDownloadCompleted(int operationId, String urlAddress, ByteArrayOutputStream result) {
        ...
        if (operationId == kDownloadOperation_VersionsDatabase) {
            ...
            if (success) {
                ...
                com.prestoncinema.app.update.ReleasesParser.BasicVersionInfo release = (com.prestoncinema.app.update.ReleasesParser.BasicVersionInfo) mDownloadTask.getTag();
    ...
    private Map<String, com.prestoncinema.app.update.ReleasesParser.BoardInfo> getReleases() {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(mContext);
        String releasesXml = sharedPreferences.getString("updatemanager_releasesxml", null);

        return com.prestoncinema.app.update.ReleasesParser.parseReleasesXml(releasesXml);
    }
    ...
    public void onDataAvailable(BluetoothGattCharacteristic characteristic) {
        ...
        if ((mDeviceInfoData.manufacturer != null || !bleManager.isCharacteristicReadable(deviceInformationService, kManufacturerNameCharacteristic))
            ...
            if (mListener != null) {
                ...
                Map<String, com.prestoncinema.app.update.ReleasesParser.BoardInfo> allReleases = getReleases();
                com.prestoncinema.app.update.ReleasesParser.FirmwareInfo latestRelease = null;
                ...
                if (isManufacturerCorrect && mDeviceInfoData.modelNumber != null) {
                    com.prestoncinema.app.update.ReleasesParser.BoardInfo boardInfo = allReleases.get(mDeviceInfoData.modelNumber);
                    if (boardInfo != null) {
                        List<com.prestoncinema.app.update.ReleasesParser.FirmwareInfo> modelReleases = boardInfo.firmwareReleases;
                        if (modelReleases != null && modelReleases.size() > 0) {
                            ...
                            if (!latestRelease.isBeta) {
                                ...
                                if (mDeviceInfoData.getBootloaderVersion().compareToIgnoreCase(latestRelease.minBootloaderVersion) >= 0) {
                                    ...
                                    if (com.prestoncinema.app.update.ReleasesParser.versionCompare(latestRelease.version, versionToIgnore) != 0) {

                                        if (mDeviceInfoData.softwareRevision != null) {
                                            final boolean isNewerVersion = com.prestoncinema.app.update.ReleasesParser.versionCompare(latestRelease.version, mDeviceInfoData.softwareRevision) > 0;
    ...
    private final BroadcastReceiver mDfuUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (com.prestoncinema.app.update.DfuService.BROADCAST_PROGRESS.equals(action)) {
                final int progress = intent.getIntExtra(com.prestoncinema.app.update.DfuService.EXTRA_DATA, 0);
                final int currentPart = intent.getIntExtra(com.prestoncinema.app.update.DfuService.EXTRA_PART_CURRENT, 1);
                final int totalParts = intent.getIntExtra(com.prestoncinema.app.update.DfuService.EXTRA_PARTS_TOTAL, 1);
            ...
            } else if (com.prestoncinema.app.update.DfuService.BROADCAST_ERROR.equals(action)) {
                final int error = intent.getIntExtra(com.prestoncinema.app.update.DfuService.EXTRA_DATA, 0);
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        manager.cancel(com.prestoncinema.app.update.DfuService.NOTIFICATION_ID);
                    }
                }, 200);
            }
        }
    ...
    private void updateProgressBar(final int progress, final int part, final int total, final boolean error) {
        switch (progress) {
            case com.prestoncinema.app.update.DfuService.PROGRESS_CONNECTING:
                if (mProgressDialog != null) {
                    mProgressDialog.setIndeterminate(true);
            ...
            case com.prestoncinema.app.update.DfuService.PROGRESS_STARTING:
                if (mProgressDialog != null) {
                    mProgressDialog.setIndeterminate(true);
            ...
            case com.prestoncinema.app.update.DfuService.PROGRESS_ENABLING_DFU_MODE:
                if (mProgressDialog != null) {
                    mProgressDialog.setIndeterminate(true);
            ...
            case com.prestoncinema.app.update.DfuService.PROGRESS_VALIDATING:
                if (mProgressDialog != null) {
                    mProgressDialog.setIndeterminate(true);
            ...
            case com.prestoncinema.app.update.DfuService.PROGRESS_DISCONNECTING:
                if (mProgressDialog != null) {
                    mProgressDialog.setIndeterminate(true);
            ...
            case com.prestoncinema.app.update.DfuService.PROGRESS_COMPLETED:
                if (mProgressDialog != null) {
            ...
            case com.prestoncinema.app.update.DfuService.PROGRESS_ABORTED:
                if (mProgressDialog != null) {
            ...
            default:
                ...
                if (error) {
                    String message = String.format(mContext.getString(R.string.firmware_updatefailed_format), GattError.parse(progress) + " (" + (progress & ~(com.prestoncinema.app.update.DfuService.ERROR_MASK | com.prestoncinema.app.update.DfuService.ERROR_REMOTE_MASK)) + ")");
                    Log.w(TAG, message);
    ...
    private static IntentFilter makeDfuUpdateIntentFilter() {
        ...
        intentFilter.addAction(com.prestoncinema.app.update.DfuService.BROADCAST_PROGRESS);
        intentFilter.addAction(com.prestoncinema.app.update.DfuService.BROADCAST_ERROR);
        intentFilter.addAction(com.prestoncinema.app.update.DfuService.BROADCAST_LOG);
        return intentFilter;
    }
    // endregion
