...
public class CameraSource {
    ...
    public static class Builder {
        ...
        public Builder setRequestedPreviewSize(int width, int height) {
            ...
            // menu_devices can support.  We bound this to avoid int overflow in the code later.
     ...
     * this function will return the focus position to the default_lenses.
    ...
    /**
     * Gets the index for the camera specified by the direction it is facing.  Returns -1 if no such
     * camera was found.
     *
     ...
     * preview images on some menu_devices, the picture size must be set to a size that is the same
     ...
     * preview images may be distorted on some menu_devices.
     */
    ...
    /**
     * Calculates the correct rotation for the given camera index and sets the rotation in the
     * parameters.  It also sets the camera's display orientation and rotation.
     *
     * @param parameters the camera parameters for which to set the rotation
     * @param cameraId   the camera index to set rotation based on
     */
