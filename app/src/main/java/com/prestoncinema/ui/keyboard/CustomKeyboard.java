package com.prestoncinema.ui.keyboard;
    ...
    public CustomKeyboard(Activity activity) {
        ...
        if (keyboardContainer != null) {
            ...
            if (currentapiVersion > Build.VERSION_CODES.KITKAT) {
                // Workaround for menu_devices with softkeys. We cant not use  getRootView() because the keyboard would be below the softkeys.
